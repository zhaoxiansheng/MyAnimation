...
public class ReflectUtil {
     ...
     * @return  Class named className
     *
     * construct a class without initilize the class
     */
    public static Class<?> getClazz_dry(String className)
    {
        Class<?> clazz = null;
        try {
            clazz = Class.forName(className, false, VMStack.getCallingClassLoader());
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        return clazz;
     ...
     *
     */
    public static Class<?> getClazz(String className, boolean bInit)
    {
        Class<?> clazz = null;
        try {
            clazz = Class.forName(className, bInit, VMStack.getCallingClassLoader());
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        return clazz;
